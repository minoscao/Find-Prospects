...
export function mergeVerification(customer,result){
 ...
 return {...patch,channelRatings,channelVerification:{verifiedAt:result.verifiedAt,nextCheckAt:result.nextCheckAt,checks:result.checks,website:customer.website}};
}
